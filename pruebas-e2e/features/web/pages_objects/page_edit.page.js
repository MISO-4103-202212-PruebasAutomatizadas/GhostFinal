...
class PageEditPage extends Page {
  ...
  get settingsMenuButton() { return this._driver.$("button.settings-menu-toggle") }
  ...
  get deleteConfirmButton() { return this._driver.$("div.modal-content .modal-footer button:nth-of-type(2)") }
